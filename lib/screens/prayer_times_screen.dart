...
class _PrayerTimesScreenState extends State<PrayerTimesScreen> {
  ...
  String _locationName =
      'default_location'.tr; // 🌟 مفتاح فلسطين أو الموقع الافتراضي
  ...
  String _nextPrayerKey =
      ''; // 🌟 حفظ مفتاح الترجمة بدلاً من الاسم العربي الثابت
  ...
  void _calculatePrayers() {
    ...
    setState(() {
      ...
      if (nextPrayer != Prayer.none) {
        ...
        final nextPrayerTime = prayerTimesData
  ...
  Widget build(BuildContext context) {
    ...
    final hijriDate =
        "${hijriDateData.hDay} ${hijriDateData.longMonthName} ${hijriDateData.hYear} ${'hijri_symbol'.tr}";
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${'next_prayer_title'.tr}: ${_nextPrayerKey.tr}',
                                    style: TextStyle(
                              ...
                              Text(
                                '${'time_left_for'.tr} ${_nextPrayerKey.tr}',
                                style: TextStyle(
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (c, i) =>
                              _buildPrayerCard(_prayerTimes[i], isRtl),
                        ),
                      ],
                    ),
                  ),
